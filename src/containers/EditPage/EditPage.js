...
class EditPage extends Component {
  ...
  onDelete = () => {
    fetch(`/api/delete-offer-id/${this.state.offerID}`)
      .catch(function (error) {
        window.alert(`[Error] ${error}`);
      })
      .then((res) => res.json())
      ...
      <div className={classes.editorContainer}>
          ...
          <div className={classes.modifyArea}>
            <div className={classes.subModifyArea}>
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ offerID: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ numSearch: e.target.value })
                }
              />
              <FormControl className={classes.basicData}>
                ...
                <Select
                  ...
                  onChange={(e) =>
                    this.handleTextareaChange({ category: e.target.value })
                  }
                  displayEmpty
              ...
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ cardName: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ cardID: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ beginDate: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ endDate: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ timingToOffer: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ limits: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ userIdentity: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    timingOfConsumption: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    numberOfConsumption: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ type: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ channels: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ amounts: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ others: e.target.value })
                }
              />
            </div>
            <div className={classes.mainModifyArea}>
              ...
              <TextareaAutosize
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ offerName: e.target.value })
                }
              />
              摘要 offerAbstract
              <TextareaAutosize
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ offerAbstract: e.target.value })
                }
              />
              詳細內容 contents
              <TextareaAutosize
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ contents: e.target.value })
                }
              />
              筆記 notes
              <TextareaAutosize
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ notes: e.target.value })
                }
              />
            </div>
          </div>
        ...
        <div className={classes.cardActions} align="center">
          <ButtonGroup size="large" variant="contained" color="primary">
            <Button
              className={clsx(classes.cardButton, classes.saveButton)}
              size="small"
              onClick={this.onSave}
            >
              Save
            ...
            <Button
              ...
              onClick={() => {
                if (
                  window.confirm("Are you sure you wish to delete this Offer?")
                )
                  this.onDelete();
              }}
            >
