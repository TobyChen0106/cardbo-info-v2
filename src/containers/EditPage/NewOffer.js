...
import {
  ...
  offerList2Offer,
  offer2OfferList,
} from "../../components/objects/emtyOffer";
...
class EditPage extends Component {
  ...
  onSave = () => {
    const new_data = offerList2Offer(this.state);
          ...
          <div className={classes.modifyArea}>
              ...
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    cardInfo_cardName: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ cardInfo_cardID: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    expiration_beginDate: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    expiration_endDate: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    reward_timingToOffer: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ reward_limits: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    constraint_userIdentity: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    constraint_timingOfConsumption: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    constraint_numberOfConsumption: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ constraint_type: e.target.value })
                }
              />
              <TextField
                className={classes.basicData}
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    constraint_channels: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    constraint_amounts: e.target.value,
                  })
                }
              />
              <TextField
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    constraint_others: e.target.value,
                  })
                }
              />
            </div>
            <div className={classes.mainModifyArea}>
              ...
              <TextareaAutosize
                ...
                onChange={(e) =>
                  this.handleTextareaChange({ reward_contents: e.target.value })
                }
              />
              筆記 notes
              <TextareaAutosize
                ...
                onChange={(e) =>
                  this.handleTextareaChange({
                    reward_notes_sentences: e.target.value,
                  })
                }
              />
            </div>
